...
totalTime = 100; % total tid areanberäkningen ska köra efter att den börjat
...
T = 100;         % Plotta upptäckt area som funktion av kiralitet vid tvärsnitet tiden lika med T s efter pretime
...
[kir_sorted, sortOrder] = sort(abs(kir2));
...
[kir_sorted1, sortOrder1] = sort(abs(kir2(1:50)));
normA11 = area1(sortOrder1);

[kir_sorted2, sortOrder2] = sort(abs(kir2(50:86)));
